...
export class PasswordValidatorService {
  ...
  private generateUrl = 'https://clave-segura.onrender.com/api/generate-password';
  ...
  generatePassword(word: string): Observable<PasswordGenerationResponse> {
    return this.http.post<PasswordGenerationResponse>(this.generateUrl, { word });
  }
}
